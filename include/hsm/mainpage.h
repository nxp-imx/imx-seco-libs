 ...
 * 4.2 | Mar 31 2021  | - AES CCM IV handling updated to match AES GCM, to guarantee unique IV's (not backward compatible). \n - Add the OTP Root KEK flag to the manage Key on DXL B0. \n - Add the support of HMAC and TLS on DXL B0. \n - Update the list of unsupported curves on DXL.
 * 4.3 | June 06 2022 | - Reword to highlight difference between i.MX8DXL B0 Vs other devices in case of CCM.
 * 4.4 | Sep 14 2022  | - Update CCM IV handling descriptions, DXL A1 and B0 devices now have same handling.
 * */
